...
### NOMAL INPUT ###
out=$(echo 1 2 3 4 | ./find_zero_equations)
...
out=$(echo 1 3 5 10 | ./find_zero_equations)
[ "${out}" = "[1 - 3 + 10 / 5 = 0]  [1 + 10 / 5 - 3 = 0]  [3 - 1 - 10 / 5 = 0]  [3 - 10 / 5 - 1 = 0]  [10 / 5 + 1 - 3 = 0]  [10 / 5 - 3 + 1 = 0]" ] || ng "$LINENO"

out=$(echo 1 5 3 10 | ./find_zero_equations)
[ "${out}" = "[1 - 3 + 10 / 5 = 0]  [1 + 10 / 5 - 3 = 0]  [3 - 1 - 10 / 5 = 0]  [3 - 10 / 5 - 1 = 0]  [10 / 5 + 1 - 3 = 0]  [10 / 5 - 3 + 1 = 0]" ] || ng "$LINENO"

out=$(echo 1 5 3 2 | ./find_zero_equations)                                                                        
...
# 解なし
out=$(echo 8 3 3 6 | ./find_zero_equations)
[ "${out}" = "等式は見つかりませんでした" ] || ng "$LINENO"

out=$(echo 1 2 3 10 | ./find_zero_equations)
[ "${out}" = "等式は見つかりませんでした" ] || ng "$LINENO"
